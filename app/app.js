...
(function () {
  ...
  var PHASES = {
    ...
    follicular: { name: "Фолликулярная", short: "Подъём", emoji: "🌱", color: "var(--p-follicular)",
      today: "Сил становится больше. У многих сразу после месячных растёт и желание.",
  ...
  var KB = [
    ...
    { k: ["либидо","влечен","желани"], a: "Либидо очень индивидуально. У многих оно выше сразу после месячных, а не «в овуляцию». Миф, что в овуляцию все «хотят»: часто наоборот — бывает боль и желания нет. Ориентируйся на себя, а не на стереотипы." },
  ...
  function screenSettings() {
    return head("Настройки", "back") +
      ...
      '<p class="caption">Версия 2.2 · MVP-демо. Прогнозы — ориентир, не медицинская рекомендация.</p>';
  }
