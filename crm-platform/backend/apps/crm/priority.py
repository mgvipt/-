...
def classify(messages):
    ...
    try:
        ...
        _c = AgentConfig.get()
        r = claude_json("\n".join(lines), model=(_c.priority_model or "claude-haiku-4-5"), max_tokens=120, system=_PROMPT, cache=_c.cache_enabled, source="Помощник: важность чатов (какой срочный)")
    except Exception:
        return "", ""
