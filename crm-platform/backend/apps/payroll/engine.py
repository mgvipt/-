...
WH_RATE_INFO = {
    ...
    "WH_TINT_PCT": ("% від «Послуга тонування»", "yes", "так — при відвантаженні: % від рядка «Послуга тонування» в угоді (якщо рядка немає — за відміченими тонованими наборами)"),
    "WH_RATE_DAY": ("₴/день", "day", "лише кнопкою «Завершити день» (мінус за перебір обіду)"),
    "bundle_assembly": ("₴/набір", "yes", "так — при відвантаженні, за кожен тестовий набір в угоді"),
    # 17.09.2026: ціни для КЛІЄНТА (не ЗП складу) — живуть поруч, бо тонування наборів/викрасок налаштовується тут же
    "KIT_TINT_PRICE_IND": ("₴/набір", "client", "ціна клієнту: індивідуальний колір тест-набору (доплата окремим рядком)"),
    "KIT_TINT_PRICE_RICH": ("₴/набір", "client", "ціна клієнту: насичений колір набору, від — від 20 мл колоранту на 250 г матеріалу"),
    "SAMPLE_TINT_PRICE_IND": ("₴/викраска", "client", "ціна клієнту: доплата за індивідуальний колір викраски (150 → 250 ₴)"),
}
