...
«Хочу, щоб ШІ не відправляв клієнтів у телеграм-бот, а слав посилання з нашої бази CRM: презентація
...
def personalize(text, conv):
    ...
    • будь-яке посилання wallcov.com.ua/p/… (його міг написати менеджер або ШІ) робимо ПЕРСОНАЛЬНИМ —
