...
• доставка на відділення безкоштовна: тонкошарові від 6000 ₴, якщо їх ≥70% замовлення; фактурні (Pattera, Slate, травертин, марморин) від 20000 ₴; фарби Primalex / Play&Clean — завжди платна; менший чек і курʼєр — за тарифом НП (памʼятка 13.09)
