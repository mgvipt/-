...
- 13.09.2026: тексти В1 / Т1 / нагадування затверджені Олегом; тестовий режим (test_mode) — просьби (авто і кнопка
  ...
  просьба вже в журналі; відповідь клієнта на просьбу не запускає ШІ-агента (is_review_reply).
...
def is_review_reply(contact_id, now=None, days=60):
    ...
    за `days` днів — з посиланням на відгук. Тоді ШІ-агент не чіпає ліди й угоди клієнта: «дякую» на просьбу —
