...
CHECKS = [
    ...
    ("ШІ-РОП: питання по угоді (маршрут підключено)", "owner", "/api/deals/999999999/ask_analyst/", {404, 405}, []),
    # 22.09.2026 (Олег): продавець CRM і ШІ-РОП знають, з якої реклами клієнт (клієнт з реклами Галатеї)
    ("Чат: реклама, з якої прийшов клієнт", "owner", "/api/conversations/6882/ad_context/", {200}, ["ad_title"]),
    ...
    ("Контент-завод: каруселі", "owner", "/api/content-factory/carousels/", {200}, ["carousels", "templates"]),
