...
from apps.warehouse.technical_facts import ProductTechnicalSheet
from apps.inbox.sales_scripts import SalesScripts
...
router.register("day-snapshots", fin_views.DaySnapshotViewSet, basename="day-snapshots")
...
urlpatterns = [
    ...
    path("", include("apps.assistant.urls")),  # особистий асистент Олега (24.09.2026)
    ...
    path("api/inbox/sales-scripts/", SalesScripts.as_view()),
    ...
    path("api/inbox/thumb/<int:message_id>/<int:idx>/", inbox_views.ThumbView.as_view()),
    ...
    path("api/bounty/", include("apps.bounty.urls")),  # біржа задач (14.09.2026)
    path("api/returns/", include("apps.returns.urls")),  # повернення товару від клієнта (16.09.2026)
