...
INSTALLED_APPS = [
    ...
    "apps.content_factory",  # контент-завод: рилси, каруселі, TG, аналітика сторінок (24.09.2026)
    "apps.assistant",  # особистий ШІ-асистент Олега: TG Business → пропозиції в базу знань (24.09.2026)
    ...
    "apps.meta_attr",  # мітки реклами Meta + сирий лог вебхуків 30 днів (14.09.2026)
    "apps.payroll",  # ставки співробітників — одне місце для ЗП і точки беззбитковості (14.09.2026)
    "apps.bounty",  # біржа задач (14.09.2026)
    "apps.returns",  # повернення товару від клієнта: склад, гроші (лише бухгалтер), звіт (16.09.2026)
]
...
# Ліміт розміру POST (base64-фото інвентаризації тощо) — інакше Django ріже великі тіла на 2.5MB
