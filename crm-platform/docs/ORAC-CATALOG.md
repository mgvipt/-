...
## Official archive interiors v3 —09.09.2026
Oleg requested more real interior examples and accurate thumbnail types.16 official download-centre assets were matched visually to numbered SKU labels in OracDecorBook_2020_001.pdf;9 duplicate SKU/image relations rejected.15 originals add34relations across23products (pilotC3541→2,P40202→5; then21products30relations). No PDF-extracted photo republished: use official download-centre original endpoint, preserve rights_source/catalogue page/caption/evidence in media_provenance. Totals1086ProductImage,834unique files;264SKU with interior/application images,409PDFdrawing links,90multipleprofileviews. NoCezarwrites. C200TheMint remainsheld.
Existing1052ProductImage alt captions classified by reviewedSKU+SHA evidence, with manual-edit guard, exact row backup and ordinaryshop queue. PilotW100/C2005imagesverifiedlive, then1047images419products. New34descriptivecaptions preserved. Unknown sources are not inferred from position. Both enrichment and caption commands repeat with0writes.
Local source/evidence: work/interior-v2/{selected,assets,dedup,matches}.json; catalogue numbered-page screenshots reviewed. Source transformations onlyEXIF/proportionalmax1800/WebP90. Product IDs, prices, stock, fulltext remainunchanged. Gallery background grey is shopowner releasef111694, current user rulev5.

Final delivery:421published,0ready,0errors. Three transient HTTP502 during shopdeploy recovered by exact requeue1158/1159/1160; all nowpublished.23/23expanded public galleries have expectedcounts;34/34newpublicimage bytes match preparedSHA. SX157480/stock35 andC2131440/stock10 unchanged. ChangeLog125 expanded with filters/ranges/mm/unknown/reset/thumbtypes/zoom/docs; authenticatedAPI200 andUIverified. IndependentFlex+height>=200 returns13;reset421.
