/* «Розвиток» v2 (16.09.2026, рішення Олега: «синхронно з ЗП і KPI; публічний рейтинг прибери, мотивуй людей»).
   ...
   Власник / РОП: зведення команди, змагання тижня з кнопкою «Нарахувати приз» (через Біржу задач) і вибірка чатів для ШІ.
  ...
  return (
    <div className="panel">
      ...
      <label style={{ display: "flex", gap: 8, alignItems: "flex-start", fontSize: 12.8, cursor: "pointer" }}>
        ...
        <span>{t("Раз в неделю ИИ разбирает случайную выборку чатов каждого менеджера — тогда метрика станет «качество разговоров (звонки + чаты)». Стоит денег.", "Раз на тиждень ШІ розбирає випадкову вибірку чатів кожного менеджера — тоді метрика стане «якість розмов (дзвінки + чати)». Коштує грошей.")}
