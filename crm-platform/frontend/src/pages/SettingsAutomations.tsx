  ...
  return (
    <div>
      <div className="note">{t(
        ...
        "Логіка руху по воронці: за якої події лід/сделка переходить на наступну стадію. Це той самий двигун, що рухає картки — змінюєш тут, змінюється поведінка. Кожен перехід пишеться в Історію змін.")}</div>
