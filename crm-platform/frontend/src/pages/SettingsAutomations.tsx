        ...
        <div style={{ display: "grid", gridTemplateColumns: "minmax(0,1fr) minmax(0,1fr)", gap: 18 }}>
          ...
          <section>
            ...
            {automation && <div style={{ display: "grid", gap: 9 }}>
              ...
              <textarea style={{ ...box, minHeight: 110 }} value={automation.reply_text || ""} onChange={(e) => setAutomation({ ...automation, reply_text: e.target.value })} placeholder="Повідомлення в Direct. {form_url} заміниться на адресу форми." />
