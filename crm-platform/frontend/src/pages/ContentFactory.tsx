...
/* Меню (етап 1 редизайну, 26.09.2026): три групи — «Спільне для всіх блогів», «Бази знань» (не блоги), «Блог ● назва».
 * scope показує, від чого залежить вкладка; hint — коротко «для чого · де налаштовується · на що впливає». */
type Scope = "shared" | "kb" | "blog";
type Section = { id: string; label: string; stage: number; group?: string; live?: boolean; what?: string[]; scope: Scope; icon: string; hint: string; kb?: string };
const KB_SLUGS = ["marketing", "business"];
/* Підказки «Що тут що» для кожної вкладки (звірено з кодом 26.09.2026). */
type TipT = { about: string; hints: { block: string; hint: string }[] };
const CF_HINTS: Record<string, TipT> = {"studio": {"about": "Пульт: зведення по всьому заводу — питання, матеріал, чернетки, план, витрати. Однакове для всіх блогів.", "hints": [{"block": "Питають", "hint": "Для чого: скільки разів клієнти питали за 7 днів у всіх темах · На що впливає: клік відкриває «Питання клієнтів». Рахуються лише переписки Wallcov."}, {"block": "Матеріал", "hint": "Для чого: скільки фото й відео є в «Джерелах» і скільки прийшло за добу — по всіх блогах разом · Клік відкриває «Джерела контенту»."}, {"block": "Ідеї", "hint": "Для чого: скільки роликів відстежуваних сторінок (усіх блогів) помітно вистрілили за тиждень · Клік відкриває «Стрічку рекомендацій»."}, {"block": "Виробництво", "hint": "Для чого: чернетки рилсів плюс чернетки Telegram-постів, які чекають вашого рішення · Каруселі сюди не рахуються."}, {"block": "Вийшло", "hint": "Для чого: скільки постів вийшло в Telegram за 7 днів і їхні перегляди · Рилси й каруселі тут не рахуються."}, {"block": "Про що питають цього тижня", "hint": "Для чого: 4 найчастіші теми питань за тиждень · Де налаштовується: «Питання клієнтів», тема «Не для контенту» звідси зникає."}, {"block": "пост", "hint": "Для чого: просто відкриває Telegram-автопілот · Тему з рядка не передає — пост пишеться з найчастішої теми або вручну."}, {"block": "рилс", "hint": "Для чого: просто відкриває «Рилси» · Тему з рядка не передає — ідею для рилса вибираєте в майстрі заново."}, {"block": "Чекає вашого рішення", "hint": "Для чого: скільки чернеток постів і рилсів чекають «Схвалити» або «Відхилити» · Клік веде у відповідну вкладку."}, {"block": "Заплановано", "hint": "Для чого: схвалені Telegram-пости з датою · На що впливає: у свій час такий пост виходить у канал сам, без кнопки (перевірка кожні 5 хвилин)."}, {"block": "Вистрілило в ніші за тиждень", "hint": "Для чого: до 3 роликів конкурентів і натхнення, що набрали більше звичного · Де налаштовується: «Сторінки» і «Стрічка»."}, {"block": "Витрати ШІ за місяць", "hint": "Для чого: витрати Питань, Telegram, Аналітика, Рилсів і Асистента · Каруселі й ШІ-картинки сюди не входять. Смужка — лише де є ліміт."}, {"block": "Керувати сторінками →", "hint": "Для чого: перехід до списку наших сторінок, конкурентів і натхнення · Числа поруч — по всіх блогах разом."}]}, "channels": {"about": "Сторінки для аналізу: наші, конкуренти, натхнення. Список один на всіх; «Блог …» лише фільтрує, а нова сторінка прив’язується до вибраного блогу.", "hints": [{"block": "Усі", "hint": "Для чого: показати сторінки всіх блогів, а не лише вибраного · На що впливає: лише на те, що видно на екрані."}, {"block": "Додати сторінку", "hint": "Для чого: вставте посилання на профіль — соцмережа визначиться сама · На що впливає: сторінка прив’язується до блогу, вибраного в меню."}, {"block": "Соцмережа", "hint": "Для чого: потрібна, лише якщо вставили @нік без посилання · Інакше поле неактивне — соцмережа береться з посилання."}, {"block": "Тип сторінки", "hint": "Для чого: «Наша сторінка» — рахуємо наші цифри; «Конкурент» і «Натхнення» — їхні ролики йдуть у стрічку й аналітику блогу."}, {"block": "Блог", "hint": "Для чого: до якого блогу належить сторінка · На що впливає: стрічка й аналітик блогу, @нік на слайдах каруселей (для наших сторінок)."}, {"block": "Контент", "hint": "Для чого: останні ролики сторінки з переглядами й «вистрілило ×» · Дані з’являються, лише коли сторінка вже в стрічці."}, {"block": "У стрічку", "hint": "Для чого: додати сторінку у Virale, щоб її ролики потрапляли в стрічку · Витрачає ліміт дій Virale. Ролики підтягнуться при оновленні."}, {"block": "Вимкнути", "hint": "Для чого: тимчасово не стежити за сторінкою · На що впливає: вимкнена сторінка не йде в стрічку блогу й аналітику, але лишається в списку."}, {"block": "Прибрати", "hint": "Для чого: видалити сторінку зі списку (потрібне друге натискання «Так, прибрати») · Її ролики перестануть рахуватися для блогу."}, {"block": "звичні перегляди", "hint": "Для чого: середина (медіана) переглядів сторінки · З нею порівнюється кожен ролик: «×2» — удвічі більше за звичне."}, {"block": "Вистрілило ×", "hint": "Для чого: сортувати ролики сторінки від найсильніших відносно її звичних переглядів · Нічого не змінює, лише порядок."}]}, "blogs": {"about": "Налаштування вибраного блогу: профіль, мета, майстер-промт, акаунти, база знань, зразок, пам’ять. Задає тон рилсів, каруселей і аналітика цього блогу.", "hints": [{"block": "Додати блог", "hint": "Для чого: створити новий блог з порожнім шаблоном промту · Генерувати він почне, лише коли заповните майстер-промт."}, {"block": "заповнити промт", "hint": "Для чого: позначка, що в майстер-промті ще є «[заповніть]» · На що впливає: поки вона є, рилси й каруселі цього блогу не створюються."}, {"block": "База знань CRM", "hint": "Для чого: брати ще й затверджені записи AI ЦЕНТРу та модель продажів Wallcov · На що впливає: тексти; у каруселях «Авто» — реальні фото."}, {"block": "Є власні нарізки", "hint": "Для чого: чи є в блогу свої відео · На що впливає: увімкнено — рилси монтуються з ваших кадрів; вимкнено — кадри малює ШІ."}, {"block": "Позначати ШІ-кадри", "hint": "Для чого: напис «ШІ-візуалізація» на згенерованому · На що впливає: ШІ малює стіну лише за справжнім фото фактури, безкоштовні чернетки вимкнено."}, {"block": "Мета блогу", "hint": "Для чого: чого має досягати контент (заявки, підписки…) · На що впливає: поради ШІ, ідеї продюсера й заклики в рилсах і каруселях."}, {"block": "Майстер-промт", "hint": "Для чого: головна інструкція для ШІ — тема, тон, аудиторія, заборони · На що впливає: усі тексти блогу. З «[заповніть]» блог не генерує."}, {"block": "Скласти майстер-промт", "hint": "Для чого: ШІ складе промт, заклик і опис з вашого опису (≈$0.003) · Лише вставляє чернетку в поля — далі «Зберегти блог»."}, {"block": "Заклик у кінці", "hint": "Для чого: чим закінчувати тексти (напр. написати в Direct) · На що впливає: підписи й фінальні кадри рилсів і каруселей."}, {"block": "Зберегти блог", "hint": "Для чого: записати зміни профілю, мети, промту й перемикачів · Без цього правки зникнуть при переході."}, {"block": "Додати акаунт", "hint": "Для чого: прив’язати наш акаунт до блогу · На що впливає: аналітик рахує його цифри, а @нік ставиться на слайди каруселей."}, {"block": "Додати запис", "hint": "Для чого: правило, факт, приклад або заборона для ШІ · Правила й заборони читаються завжди, факти й приклади — до 8 найближчих до теми."}, {"block": "Вимкнути", "hint": "Для чого: тимчасово прибрати запис бази знань, не видаляючи · На що впливає: ШІ перестає його враховувати, поки не ввімкнете."}, {"block": "Візуальний зразок", "hint": "Для чого: приклад ролика чи мультика → стиль, персонажі, темп (≈$0.01–0.03) · На що впливає: як ШІ малює кадри цього блогу."}, {"block": "Памʼять блогу", "hint": "Для чого: що вже вийшло й що обіцяли глядачам · «Закрити» знімає обіцянку; відкриті обіцянки підказуються в каруселях."}]}, "questions": {"about": "Теми з питань клієнтів у переписках CRM Wallcov (усі канали), групуються щоночі. Спільне: від вибраного блогу не залежить.", "hints": [{"block": "Розбір питань · витрати", "hint": "Для чого: стан нічного розбору й витрати місяця · Де налаштовується: тут — модель, ліміт і ввімкнення."}, {"block": "Модель ШІ", "hint": "Для чого: яка модель групує питання в теми · На що впливає: якість тем і ціна розбору."}, {"block": "ліміт $/міс", "hint": "Для чого: стеля витрат на розбір за місяць · На що впливає: коли досягнуто, розбір зупиняється до 1-го числа. Зберігається, коли вийдете з поля."}, {"block": "Увімкнути щоночі", "hint": "Для чого: автоматичний розбір щоночі о 03:40 · Вимкнено — ШІ не викликається, нові питання чекають."}, {"block": "Чекає розбору", "hint": "Для чого: скільки нових питань CRM відібрала з переписок без ШІ і скільки коштуватиме їх розібрати."}, {"block": "Розібрати зараз · до 120 питань", "hint": "Для чого: один прохід ШІ на 120 питань зараз, навіть якщо нічний розбір вимкнено · Решта — наступним запуском."}, {"block": "7 днів", "hint": "Для чого: за який період рахувати, скільки разів питали (7, 30 чи 90 днів) · Нічого не змінює, лише показ."}, {"block": "Статус теми", "hint": "Для чого: ручна позначка · «Не для контенту» прибирає тему з «Сьогодні» й з автопілота Telegram; «У плані» й «Контент зроблено» — лише для фільтра."}, {"block": "Як питають", "hint": "Для чого: показати справжні формулювання клієнтів з переписок · Зручно брати слова для гачка."}, {"block": "немає в базі знань", "hint": "Для чого: на тему ще немає затвердженої відповіді в AI ЦЕНТРі · Пост чи рилс на неї матимуть менше перевірених фактів."}, {"block": "Усі робочі", "hint": "Для чого: фільтр тем за статусом (усі, крім «Не для контенту») · Нічого не змінює, лише показ."}]}, "sources": {"about": "Фото й відео з Telegram-груп і папок Google Drive. Показує файли вибраного блогу; чати й папки без блогу видно в усіх блогах.", "hints": [{"block": "Чати", "hint": "Для чого: Telegram-групи, де є бот @wallcov_smm_bot · Група з’являється після першого фото в ній."}, {"block": "Приймати файли", "hint": "Для чого: почати забирати нові фото й відео з групи · Бот бачить лише нові повідомлення, старі не підтягуються."}, {"block": "Блог чату", "hint": "Для чого: до якого блогу належить група · На що впливає: чат переходить у блог разом з уже прийнятими файлами."}, {"block": "Як підключити групу", "hint": "Для чого: 3 кроки — додати бота адміністратором, надіслати фото, натиснути «Приймати файли»."}, {"block": "Google Drive", "hint": "Для чого: брати фото й відео з папки Диска · Папку треба відкрити на читання для вказаної пошти. Файли не копіюються, лише посилання."}, {"block": "Блог папки", "hint": "Для чого: до якого блогу належать файли папки · Файли перейдуть у блог при найближчому оновленні папки."}, {"block": "Додати", "hint": "Для чого: підключити папку Google Drive за посиланням · Папка потрапляє в блог, вибраний у меню."}, {"block": "Оновити зараз", "hint": "Для чого: одразу обійти всі підключені папки Диска · Автоматично це робиться щоночі о 04:30."}, {"block": "Матеріал", "hint": "Для чого: показати лише файли одного матеріалу · Матеріал береться з того, що написано під фото в групі."}, {"block": "Пошук у підписах", "hint": "Для чого: знайти файл за словами з підпису · Що пишете під фото, стає мітками: матеріал, кімната, етап, #хештеги."}, {"block": "Сховати", "hint": "Для чого: прибрати файл із «Джерел» · На що впливає: рилси його більше не беруть; у групі чи на Диску файл лишається."}]}, "feed": {"about": "Ролики конкурентів і натхнення з Virale. Залежить від блогу: «Сторінки блогу» — лише сторінки вибраного блогу, «Усі з Virale» — всі.", "hints": [{"block": "Пошук в інтернеті й у стрічці", "hint": "Для чого: фільтрує стрічку за словом і водночас шукає ролики в інтернеті (YouTube, Instagram, TikTok…) · Пошук безкоштовний."}, {"block": "Сторінка", "hint": "Для чого: показати ролики лише однієї сторінки · Нічого не змінює, лише показ."}, {"block": "Вистрілило ×", "hint": "Для чого: сортувати за тим, у скільки разів ролик набрав більше переглядів, ніж звичайно в автора · «×3» — утричі більше."}, {"block": "Залученість", "hint": "Для чого: сортувати за часткою лайків і коментарів від переглядів · Показує, що чіпляє, а не лише що багато дивились."}, {"block": "В ідеях", "hint": "Для чого: фільтр збережених роликів · Збережені стають референсами в «Рилсах» (крок «Стиль» — «Зняти стиль з референсу»)."}, {"block": "Зроблено", "hint": "Для чого: фільтр «зроблено з наших» · Зараз завжди порожній: кнопки, яка ставить цей статус, у системі немає."}, {"block": "Сторінки блогу", "hint": "Для чого: лише сторінки вибраного блогу · Де налаштовується: «Сторінки» → блог сторінки й «У стрічку»."}, {"block": "Оновити з Virale", "hint": "Для чого: підтягнути свіжі ролики зараз · Автоматично — щодня о 06:40. Безкоштовно, Virale вже оплачено."}, {"block": "В ідеї", "hint": "Для чого: зберегти ролик як ідею · На що впливає: він з’явиться серед референсів стилю в «Рилсах»; «З ідей» — повернути назад."}, {"block": "Сховати", "hint": "Для чого: прибрати ролик зі стрічки · Знайти його можна у фільтрі «Сховані»."}, {"block": "Рилс за референсом", "hint": "Для чого: вибрані в пошуку ролики (до 3) відкриваються в майстрі нового рилса як референс · Кадри беруться з наших відео."}, {"block": "ШІ-ремейк: усе нове", "hint": "Для чого: взяти будову й темп вибраних роликів, а всі кадри ШІ намалює заново (≈$0.07 за кадр) · Відкриває майстер рилса."}, {"block": "Показати ще", "hint": "Для чого: наступна сторінка результатів пошуку в інтернеті · До 5 сторінок."}]}, "analyst": {"about": "Звіт ШІ: що спрацювало, що ні, 5 ідей. Звіти окремі для кожного блогу; для Wallcov — Instagram, питання, Telegram і ніша, для інших — їхні сторінки й пам’ять.", "hints": [{"block": "Щопонеділка звіт", "hint": "Для чого: автоматичний звіт щопонеділка о 08:30 · Автоматично робиться лише звіт Wallcov; для інших блогів — кнопкою."}, {"block": "Увімкнути щотижня", "hint": "Для чого: увімкнути або вимкнути щотижневий звіт · Налаштування одне на всі блоги."}, {"block": "Модель ШІ", "hint": "Для чого: яка модель пише звіт · На що впливає: глибина звіту й ціна. Одна на всі блоги."}, {"block": "Витрачено цього місяця", "hint": "Для чого: витрати аналітика з ліміту місяця · Ліміт спільний для всіх блогів; змінити його на цьому екрані не можна. На ліміті звіт не робиться."}, {"block": "Зробити звіт за тиждень", "hint": "Для чого: звіт зараз для вибраного блогу, до хвилини · Коштує орієнтовно стільки, скільки вказано в «Ціна одного звіту»."}, {"block": "Звіт", "hint": "Для чого: вибрати один з попередніх звітів цього блогу (до 10) · Нічого не змінює, лише показ."}, {"block": "Медіана ніші", "hint": "Для чого: звичні перегляди відстежуваних сторінок ніші · Порівнюйте з «Медіана переглядів» наших. Цифри є лише у звітах Wallcov."}, {"block": "5 ідей на тиждень", "hint": "Для чого: ідеї з гачком і поясненням · В рилси чи каруселі не передаються самі — беріть вручну."}]}, "reels": {"about": "Рилси вибраного блогу: майстер з 7 кроків від ідеї до готового ролика. Список і нові рилси — окремі для кожного блогу; блог має бути налаштований.", "hints": [{"block": "+ Новий рилс", "hint": "Для чого: почати новий рилс для вибраного блогу · Кнопка є, лише коли майстер-промт блогу заповнено."}, {"block": "витрачено цього місяця", "hint": "Для чого: витрати на тексти рилсів (без ліміту) і ШІ-картинки · Картинки мають спільну стелю $10 на місяць — далі ШІ не малює."}, {"block": "Звідки взяти ідею", "hint": "Для чого: джерело ідеї — ШІ, наші відео, база знань, своя ідея, референс чи пошук · На що впливає: 5 варіантів від продюсера."}, {"block": "ШІ-ремейк: усе в кадрі нове", "hint": "Для чого: взяти лише будову й темп референсу, а кадри намалювати заново · Кожен кадр ≈$0.07."}, {"block": "Запропонувати ідеї · ≈$0.02", "hint": "Для чого: продюсер пропонує варіанти подачі під мету блогу · Вибрану ідею можна підправити перед сценарієм."}, {"block": "З чого монтувати", "hint": "Для чого: з відео матеріалу, з вибраних відео (1–6) або всі кадри малює ШІ · Де налаштовується: «Є власні нарізки» у «Блогах»."}, {"block": "Хто озвучує", "hint": "Для чого: голос ElevenLabs або без озвучки · Витрачає символи вашого тарифу ElevenLabs (~40 тис. на місяць)."}, {"block": "Скласти сценарій заново · ≈$0.03", "hint": "Для чого: сценарист пише всі кадри з нуля · «Переписати тексти» міняє лише слова, «↶ Повернути тексти» відкочує."}, {"block": "✓ Затвердити", "hint": "Для чого: підтвердити кадр після перегляду · На що впливає: далі до «Стилю» не пустить, поки не затверджені всі кадри."}, {"block": "Чернетка · безкоштовно", "hint": "Для чого: швидкий простий кадр від безкоштовного сервісу · Для Wallcov (позначка ШІ-кадрів) насправді малює платно, ≈$0.07."}, {"block": "Покращити ШІ · ≈$0.07", "hint": "Для чого: ШІ перемальовує копію кадру (світло, різкість) · Для Wallcov просить не міняти фактуру; «Повернути справжній» — відкат."}, {"block": "Монтажер: розставити ефекти (безкоштовно)", "hint": "Для чого: автоматично розставити переходи й рух камери · Можна потім поправити вручну в таблиці."}, {"block": "Змонтувати чорновий варіант", "hint": "Для чого: зібрати відео 9:16 з кадрів, тексту й голосу · Після змін натискайте «Зберегти й перемонтувати»."}, {"block": "Перевірити командою · ≈$0.02", "hint": "Для чого: SMM, монтажер і контролер бренду оцінюють ролик · Кожне зауваження — з кнопкою «Застосувати»."}, {"block": "Версії для TikTok і YouTube", "hint": "Для чого: ті самі кадри з текстом у безпечній зоні цих мереж · Безкоштовно, без ШІ. Файли — кнопками «TikTok ↓», «YouTube ↓»."}, {"block": "Адаптувати для блогу", "hint": "Для чого: копія рилса для іншого блогу — переписується лише текст (≈$0.01), кадри ті самі · З’явиться в рилсах того блогу."}, {"block": "Опублікувати в Instagram", "hint": "Для чого: одразу викласти в @dekor_dlia_stin (є друге підтвердження) · Лише для Wallcov; для інших блогів публікації немає."}]}, "carousels": {"about": "Каруселі вибраного блогу: задум → слайди → готовий пост. Список, тексти й підписи — окремі для кожного блогу; блог має бути налаштований.", "hints": [{"block": "Про що карусель", "hint": "Для чого: одна думка, яку має винести людина · Кнопки «↩» підставляють відкриті обіцянки з пам’яті блогу."}, {"block": "Як будуємо", "hint": "Для чого: тип подачі й дія наприкінці (зберегти, переслати, коментар, заявка, підписка) · На що впливає: структура й заклик."}, {"block": "Картинки", "hint": "Для чого: звідки фото · «Авто» — реальні фото для Wallcov, без фото для інших блогів; «ШІ» — ≈$0.07 за слайд."}, {"block": "Згенерувати карусель", "hint": "Для чого: ШІ пише слайди й підпис, підбирає картинки · ≈$0.03 за текст, 1–2 хв. До тексту додаються факти з баз знань."}, {"block": "Новий текст слайда · ≈$0.01", "hint": "Для чого: переписати один слайд з урахуванням побажання · Ваші ручні правки спершу зберігаються й беруться за основу."}, {"block": "Фото з бібліотеки", "hint": "Для чого: поставити на слайд реальне фото з бібліотеки CRM · Безкоштовно."}, {"block": "Покращити ШІ", "hint": "Для чого: ШІ перемальовує копію фото (≈$0.07) · Для Wallcov просить не міняти фактуру, але звіряйте; «↶ Повернути попередню картинку» — відкат."}, {"block": "Інтерʼєр з цією фактурою · ≈$0.07", "hint": "Для чого: ШІ малює кімнату зі стіною за цим реальним фото фактури · На картинці буде «ШІ-візуалізація» (Wallcov)."}, {"block": "Переписати всі тексти · ≈$0.03", "hint": "Для чого: ШІ переписує тексти всіх слайдів · Картинки лишаються."}, {"block": "Зберегти й перемалювати", "hint": "Для чого: записати ручні правки тексту й підпису та перемалювати слайди · Без цього правки не збережуться."}, {"block": "Отримати поради · ≈$0.02", "hint": "Для чого: поради під ціль каруселі · Кожна — з кнопкою «Застосувати» (текст безкоштовно, ШІ-картинка ≈$0.07)."}, {"block": "Надіслати мені в Telegram", "hint": "Для чого: подивитися карусель на телефоні перед публікацією · Приходить лише вам."}, {"block": "Опублікувати в Instagram", "hint": "Для чого: одразу викласти в Instagram Wallcov (є друге підтвердження) · Кнопка є лише в блогу Wallcov."}, {"block": "Зробити версію 9:16 · безкоштовно", "hint": "Для чого: слайди 1080×1920 для TikTok з текстом у безпечній зоні · Без ШІ."}, {"block": "Адаптувати для іншого блогу", "hint": "Для чого: копія каруселі для іншого блогу — лише новий текст (≈$0.03), картинки ті самі."}]}, "telegram": {"about": "Пости для каналу @wallcovpro. Лише Wallcov: для інших блогів вкладка порожня; налаштування й пости спільні й від вибраного блогу не залежать.", "hints": [{"block": "Щоранкова чернетка", "hint": "Для чого: щодня о 08:10 одна чернетка з найчастішої теми питань, якої не було в каналі 30 днів · Сама не публікується."}, {"block": "ліміт $/міс", "hint": "Для чого: стеля витрат на чернетки за місяць · На ліміті нові чернетки не пишуться до 1-го числа."}, {"block": "Створити чернетку", "hint": "Для чого: написати пост зараз на тему з «Наступний пост» · Факти — з бази знань CRM, фото — реальні з бібліотеки."}, {"block": "План публікацій · 7 днів", "hint": "Для чого: що і коли вийде за тиждень · «Схвалені без дати» самі не вийдуть — їм треба «Запланувати»."}, {"block": "+ Новий пост (вручну або з ідеї)", "hint": "Для чого: власний пост; перший рядок стає назвою · Фото й відео додаються після «Створити чернетку»."}, {"block": "Написати з ідеї", "hint": "Для чого: ШІ-маркетолог пише текст з вашої ідеї (≈$0.01) · «Покращити текст маркетологом» переробляє вже написаний."}, {"block": "Перевірити ШІ", "hint": "Для чого: орфографія й незграбні місця · Показує правки; текст зміниться лише після «Прийняти правки»."}, {"block": "Інші фото · безкоштовно", "hint": "Для чого: замінити фото поста іншими реальними фото того самого матеріалу · Без ШІ."}, {"block": "+ Фото / відео", "hint": "Для чого: додати реальні фото, відео з бібліотеки або файли з Telegram-груп · Клік по мініатюрі додає чи прибирає."}, {"block": "Покращити", "hint": "Для чого: ШІ перемальовує копію фото (≈$0.07); просить не міняти фактуру, але звіряйте · Оригінал у бібліотеці не зміниться."}, {"block": "Домалювати", "hint": "Для чого: ШІ додає на копію фото те, що ви написали (≈$0.07) · Фактуру просить не чіпати; оригінал лишається."}, {"block": "Схвалити", "hint": "Для чого: дозволити публікацію · Схвалений пост з датою вийде в канал сам у свій час. «Повернути в чернетки» — скасувати."}, {"block": "Запланувати", "hint": "Для чого: день і час виходу · На що впливає: пост опублікується сам (перевірка кожні 5 хв). «Прибрати з плану» — зняти дату."}, {"block": "Надіслати мені", "hint": "Для чого: подивитися пост у Telegram до публікації · Приходить лише вам, у канал не йде."}, {"block": "Опублікувати зараз", "hint": "Для чого: одразу викласти в @wallcovpro (потрібне друге натискання) · Відкликати з CRM не можна."}, {"block": "Оновити цифри зараз", "hint": "Для чого: оновити перегляди й реакції опублікованих · Автоматично: перший тиждень щогодини, далі раз на добу до 30 днів."}]}, "publish": {"about": "Поки заглушка «скоро»: окремої вкладки публікацій і звіту «ролик → гроші» немає. Від блогу не залежить.", "hints": [{"block": "Що тут буде", "hint": "Для чого: план майбутньої вкладки · Зараз не працює. Публікувати можна кнопками в «Рилсах», «Каруселях» (лише Wallcov) і в Telegram-автопілоті."}]}, "kb": {"about": "Спільні бази знань з книг і курсів. Це не блоги: нічого не публікують, а дають прийоми для текстів усіх блогів.", "hints": [{"block": "Маркетинг", "hint": "10 730 записів. До кожного тексту рилса, каруселі й «Написати з ідеї» будь-якого блогу додається до 5 записів, що збігаються словами з темою."}, {"block": "Бізнес і найм", "hint": "4 331 запис. Зараз жоден генератор його не читає — записи лежать про запас."}, {"block": "Чого бази не торкаються", "hint": "Щоранкова чернетка Telegram, аналітик, розбір питань і поради ШІ спільних баз не читають. Підбір — за збігом слів, не за змістом."}, {"block": "Навчити блог знаннями ззовні", "hint": "Як додати курс чи книгу: виберіть базу в «Блогах» → джерело (Диск, текст, файл, посилання) → «Розібрати» → відмітити → «Додати вибрані»."}, {"block": "Дописати в майстер-промт", "hint": "Для бази знань цю галочку краще зняти: промт самої бази ніде не використовується. Текст розбирається до 20 тис. символів, документ Диска — до 50 тис."}]}};
const SECTIONS: Section[] = [
  { id: "agent", label: "Агент заводу", stage: 0, live: true, scope: "shared", icon: "bot", hint: "Чат з ШІ як з маркетологом, SMM-спеціалістом, аналітиком чи продюсером. Бачить дані заводу й бази знань, відповідає документом або дашбордом" },
  { id: "studio", label: "Пульт", stage: 0, live: true, scope: "shared", icon: "home", hint: "Що чекає рішення по всьому заводу: чернетки, ідеї, питання, витрати. Поки однаковий для всіх блогів" },
  { id: "questions", label: "Питання клієнтів", scope: "shared", icon: "chat", hint: "Про що питають клієнти в переписках CRM, згруповано в теми щоночі. Беруться з усіх каналів Wallcov", stage: 1, live: true, what: [
  ...
  { id: "sources", label: "Матеріали", scope: "shared", icon: "paperclip", hint: "Сирі фото й відео з груп Telegram і папок Google Drive. З них рилси беруть справжні кадри", stage: 4, live: true, what: [
  ...
  { id: "kb_marketing", label: "Маркетинг", stage: 0, live: true, scope: "kb", kb: "marketing", icon: "megaphone", hint: "Прийоми з книг і курсів (Уланов, Морозов, ОАЗИС, КНБ, ATM). Зараз у кожен текст потрапляє до 5 записів, схожих за словами" },
  { id: "kb_business", label: "Бізнес і найм", stage: 0, live: true, scope: "kb", kb: "business", icon: "building", hint: "Знання про найм, мотивацію й управління. Поки жоден генератор її не використовує — підключимо на етапі 2" },
  { id: "blogs", label: "Профіль блогу", stage: 0, live: true, scope: "blog", icon: "target", hint: "Мета, майстер-промт, заклик, акаунти й записи блогу. Звідси беруть тему й тон усі генератори цього блогу" },
  { id: "channels", group: "Ідеї", label: "Конкуренти й натхнення", stage: 0, live: true, scope: "blog", icon: "users", hint: "Наші сторінки, конкуренти й натхнення цього блогу. Звідси беруться Стрічка ніші та звіт Аналітика" },
  { id: "feed", group: "Ідеї", label: "Стрічка ніші", scope: "blog", icon: "flame", hint: "Ролики сторінок цього блогу, що набрали в рази більше звичного. Кнопка переносить ідею в рилс", stage: 3, live: true, what: [
  ...
  { id: "analyst", group: "Ідеї", label: "Аналітик", scope: "blog", icon: "chart", hint: "Щотижневий звіт по сторінках блогу: що спрацювало і 5 ідей на тиждень", stage: 3, live: true, what: [
  ...
  { id: "reels", group: "Виробництво", label: "Рилси", scope: "blog", icon: "video", hint: "7 кроків від ідеї до готового ролика 9:16 у стилі й темі цього блогу", stage: 5, live: true, what: [
  ...
  { id: "carousels", group: "Виробництво", label: "Каруселі", scope: "blog", icon: "image", hint: "Слайди для Instagram з реальних фото й бази знань цього блогу", stage: 6, live: true, what: [
    "З бібліотеки реальних фото й бази знань, у фірмовому стилі",
    "Ціна «від» і кодове слово — лише перевірені з бази знань"] },
  { id: "telegram", group: "Публікація", label: "Telegram-пости", scope: "blog", icon: "telegram", hint: "Чернетки постів для каналу @wallcovpro. Схвалений пост з датою публікується сам", stage: 2, live: true, what: [
  ...
  { id: "publish", group: "Публікація", label: "Публікації", scope: "blog", icon: "trending-up", hint: "Що вийшло в Instagram і TikTok. Публікація вже працює з картки рилса чи каруселі", stage: 7, what: [
...
.cf-ag-item.on button{color:var(--cf-ink)}
.cf-ag-item .x{flex:0 0 auto;opacity:.5}.cf-ag-item .x:hover{opacity:1;color:var(--cf-bad)}
.cf-ag-main{display:grid;gap:10px;min-width:0}
.cf-ag-bar{display:grid;gap:8px;background:var(--cf-panel);border:1px solid var(--cf-line);border-radius:10px;padding:10px 12px}
.cf-ag-roles{display:flex;flex-wrap:wrap;gap:6px}
.cf-ag-roles button{all:unset;cursor:pointer;display:inline-flex;align-items:center;gap:6px;padding:6px 11px;border-radius:99px;border:1px solid var(--cf-line);font-size:12.5px;color:var(--cf-ink2)}
.cf-ag-roles button.on{background:var(--cf-gold);border-color:var(--cf-gold);color:#1b1608;font-weight:700}
.cf-ag-roles button:focus-visible{outline:2px solid var(--cf-blue)}
.cf-ag-sel{display:grid;grid-template-columns:repeat(2,minmax(0,260px));gap:8px}
.cf-ag-log{display:grid;gap:10px;align-content:start;min-height:240px}
.cf-ag-empty{display:flex;flex-wrap:wrap;gap:8px;align-items:center;color:var(--cf-ink2);font-size:13px}
.cf-ag-empty b{width:100%}
.cf-ag-msg{border-radius:10px;padding:10px 14px;max-width:920px;font-size:13.5px;line-height:1.55}
.cf-ag-msg.me{background:var(--cf-panel2);justify-self:end;max-width:720px}
.cf-ag-msg.me p{margin:0;white-space:pre-wrap}
.cf-ag-msg.agent{background:var(--cf-panel);border:1px solid var(--cf-line)}
.cf-ag-msg.busy{color:var(--cf-ink2);font-style:italic}
.cf-ag-msg .meta{display:flex;flex-wrap:wrap;align-items:center;gap:8px;margin-top:8px;font-size:11px;color:var(--cf-ink3)}
.cf-ag-msg .meta .cf-btn{height:24px;gap:4px}
.cf-ag-msg details{width:100%}.cf-ag-msg details ul{margin:4px 0 0;padding-left:18px}
.cf-ag-md h3{font-size:15px;margin:12px 0 6px}.cf-ag-md h4{font-size:13.5px;margin:10px 0 4px}
.cf-ag-md p{margin:0 0 6px}.cf-ag-md ul,.cf-ag-md ol{margin:0 0 8px;padding-left:20px}
.cf-ag-md code{background:var(--cf-bg);padding:1px 5px;border-radius:4px;font-size:12px}
.cf-ag-md a{color:var(--cf-blue)}
.cf-ag-pre{background:var(--cf-bg);border-radius:8px;padding:10px;overflow-x:auto;font-size:12px}
.cf-ag-tw{overflow-x:auto;margin:6px 0 10px}
.cf-ag-tw table{border-collapse:collapse;font-size:12.5px;min-width:60%;background:transparent;color:var(--cf-ink)}
.cf-ag-tw th,.cf-ag-tw td{border:1px solid var(--cf-line);padding:5px 8px;text-align:left;vertical-align:top}
.cf-ag-tw th{background:var(--cf-panel2);color:var(--cf-ink);text-transform:none;letter-spacing:0;font-size:12px}
.cf-ag-tw td{background:transparent;color:var(--cf-ink)}
.cf-ag-tw tr{background:transparent}
.cf-dash{display:grid;gap:10px;background:var(--cf-bg);border:1px solid var(--cf-line);border-radius:10px;padding:12px;margin:8px 0}
.cf-dash-t{font-size:13px}
.cf-dash-kpis{display:grid;grid-template-columns:repeat(auto-fill,minmax(150px,1fr));gap:8px}
.cf-dash-kpis .cf-kpi small{display:block;font-size:11px;color:var(--cf-ink3)}
.cf-dash-bars{display:grid;gap:4px;font-size:12px}
.cf-dash-bars > span{font-weight:700;color:var(--cf-ink2)}
.cf-dash-bars .row{display:grid;grid-template-columns:minmax(90px,200px) minmax(0,1fr) 60px;gap:8px;align-items:center}
.cf-dash-bars .row em{font-style:normal;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
.cf-dash-bars .row i{height:10px;border-radius:3px;background:var(--cf-gold);display:block}
...
.cf-subgrp{font-size:10px;font-weight:600;letter-spacing:.06em;color:var(--cf-ink3);padding:8px 10px 2px 34px;text-transform:lowercase}
.cf-nav-l{display:inline-flex;align-items:center;gap:9px;min-width:0}
.cf-nav .cf-nav-l svg{color:var(--cf-ink3)}
.cf-nav.on .cf-nav-l svg{color:var(--cf-gold)}
.cf-nav.locked .cf-nav-l{color:var(--cf-ink3)}
.cf-mast2{display:grid;gap:10px;background:var(--cf-panel);border:1px solid var(--cf-line);border-radius:10px;padding:10px 12px}
.cf-mast2.blog{box-shadow:inset 3px 0 0 var(--cf-gold)}
.cf-mast2.kb{box-shadow:inset 3px 0 0 var(--cf-blue)}
.cf-mast2-row{display:flex;align-items:center;gap:10px;flex-wrap:wrap}
.cf-scope-chip{display:inline-flex;align-items:center;gap:6px;font-size:11px;font-weight:700;letter-spacing:.04em;padding:4px 9px;border-radius:99px;background:var(--cf-panel2);color:var(--cf-ink);white-space:nowrap}
.cf-mast2-hint{flex:1 1 280px;font-size:12.5px;color:var(--cf-ink2);line-height:1.45}
.cf-tipbtn{gap:6px}
.cf-tips{margin:0;display:grid;grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:8px}
.cf-tips div{background:var(--cf-bg);border:1px solid var(--cf-line);border-radius:8px;padding:8px 10px}
.cf-tips dt{font-size:12px;font-weight:700;color:var(--cf-ink);margin-bottom:3px}
.cf-tips dd{margin:0;font-size:12px;color:var(--cf-ink2);line-height:1.45}
...
const SCOPE_TITLE: Record<Scope, string> = { shared: "Спільне для всіх блогів", kb: "Бази знань · не блоги", blog: "Вибраний блог" };
const SCOPE_NOTE: Record<Scope, string> = {
  shared: "Однакове для всіх блогів — вибір блогу тут нічого не змінює",
  kb: "Знання, з яких ШІ бере прийоми для текстів усіх блогів",
  blog: "Усе в цій групі працює лише з блогом, вибраним угорі групи",
};
type Badges = Record<string, { n: number; hot?: boolean } | undefined>;
const badgesOf = (today: Today | null): Badges => today ? {
...
function Rail({ tab, setTab, today, ctx }: { tab: string; setTab: (t: string) => void; today: Today | null; ctx: BlogCtx }) {
  const badge = badgesOf(today);
  const curBlog = ctx.blogs.find((x) => x.id === ctx.blogId);
  const item = (s: Section) => {
    const b = badge[s.id];
    const locked = s.id === "telegram" && curBlog?.slug !== "wallcov";
    return (
      <button key={s.id} type="button" className={"cf-nav" + (tab === s.id ? " on" : "") + (s.live ? "" : " later") + (locked ? " locked" : "")}
        onClick={() => setTab(s.id)} aria-current={tab === s.id ? "page" : undefined} title={s.hint}>
        <span className="cf-nav-l"><Icon n={locked ? "lock" : s.icon} size={15} />{s.label}</span>
        {locked ? <em className="soon">Wallcov</em> : b ? <em className={b.hot ? "hot" : ""}>{b.n}</em> : !s.live ? <em className="soon">скоро</em> : null}
      </button>
    );
  };
  let sub = "";
  return (
    <nav className="cf-rail" aria-label="Розділи контент-заводу">
      ...
      {(["shared", "kb", "blog"] as Scope[]).map((sc) => (
        <div key={sc} className={"cf-scope " + sc}>
          <div className="cf-grp" title={SCOPE_NOTE[sc]}>{SCOPE_TITLE[sc]}</div>
          {sc === "blog" && <BlogSwitch {...ctx} />}
          {SECTIONS.filter((x) => x.scope === sc).map((s) => {
            const head = sc === "blog" && s.group && s.group !== sub ? s.group : "";
            if (head) sub = head;
            return <div key={s.id} style={{ display: "contents" }}>{head && <div className="cf-subgrp">{head}</div>}{item(s)}</div>;
          })}
        </div>
      ))}
    </nav>
...
/** Телефон: замість бічного меню — шапка з поточним розділом і шторка з тими ж трьома групами. */
    ...
    <>
      <div className="cf-mbar">
        <button type="button" className="cf-mbar-cur" onClick={() => setOpen(true)} aria-haspopup="dialog" aria-expanded={open}>
          ...
          <span className="t"><small>{SCOPE_TITLE[s.scope]}{s.scope === "blog" && curBlog ? ` · ${curBlog.name}` : ""}</small><b>{s.label}</b></span>
      ...
      {open && (
        <div className="cf-sheet-wrap" role="dialog" aria-modal="true" aria-label="Розділи контент-заводу">
          ...
          <nav className="cf-sheet">
            ...
            {(["shared", "kb", "blog"] as Scope[]).map((sc) => (
              <div key={sc} className="cf-sheet-grp">
                <div className="cf-grp">{SCOPE_TITLE[sc]}</div>
                {sc === "blog" && <BlogSwitch {...ctx} />}
                {SECTIONS.filter((x) => x.scope === sc).map((x) => (
                  <button key={x.id} type="button" className={"cf-sheet-row" + (x.id === s.id ? " on" : "") + (x.live ? "" : " later")} onClick={() => pickTab(x.id)}>
                    <span className="cf-nav-l"><Icon n={x.icon} size={17} />{x.label}</span>
                    {badge[x.id] ? <em className={badge[x.id]?.hot ? "hot" : ""}>{badge[x.id]?.n}</em> : !x.live ? <em className="soon">скоро</em> : <i aria-hidden="true" />}
                  </button>
                ))}
              </div>
            ))}
...
function Masthead({ s, blog }: { s: Section; blog?: BlogT }) {
  const tips = CF_HINTS[s.kb ? "kb" : s.id];
  const [open, setOpen] = useState(false);
  return (
    <div className={"cf-mast2 " + s.scope}>
      <div className="cf-mast2-row">
        <span className="cf-scope-chip"><Icon n={s.scope === "blog" ? "target" : s.scope === "kb" ? "brain" : "grid"} size={13} />
          {s.scope === "blog" ? `Блог «${blog?.name || "—"}»` : SCOPE_TITLE[s.scope]}</span>
        <span className="cf-mast2-hint">{tips?.about || s.hint}</span>
        {!!tips?.hints?.length && (
          <button type="button" className="cf-btn ghost cf-tipbtn" aria-expanded={open} onClick={() => setOpen((v) => !v)}>
            <Icon n="info" size={14} />{open ? "Сховати" : `Що тут що · ${tips.hints.length}`}</button>
        )}
      </div>
      {open && tips && (
        <dl className="cf-tips">
          {tips.hints.map((h) => (<div key={h.block}><dt>{h.block}</dt><dd>{h.hint}</dd></div>))}
        </dl>
      )}
    </div>
  );
...
/** Бази знань — окремо від блогів (етап 1): поки що це редактор тієї самої записи-бази; пошук і «спитати базу» — етап 2. */
function KbPage({ s, all, reload }: { s: Section; all: BlogT[]; reload: () => void }) {
  const base = all.find((b) => b.slug === s.kb);
  if (!base) return <div className="cf-empty">Базу «{s.label}» не знайдено.</div>;
  return (
    <>
      <div>
        <h1 className="cf-h1">{s.label}</h1>
        <p className="cf-sub">{base.facts_count.toLocaleString("uk-UA")} записів. Це не блог: окремо не публікує, а дає прийоми для текстів усіх блогів.</p>
      </div>
      <BlogEditor key={base.id} id={base.id} onChanged={reload} kb />
    </>
  );
}
...
type BlogFull = BlogT & { facts_total?: number; facts_found?: number; facts_q?: string; visual: VisualT; ref_images: { id: number; who: string; url: string }[]; master_prompt: string; cta: string; template: string; facts: FactT[]; kinds: [string, string][] };
...
function BlogEditor({ id, onChanged, kb, onReel }: { id: number; onChanged: () => void; kb?: boolean; onReel?: (refs: RefPick[]) => void }) {
  ...
  const [fq, setFq] = useState(""); // пошук у базі знань (у великих базах сервер віддає до 300 записів)
  const [fqIn, setFqIn] = useState("");
  const load = useCallback(async () => {
    const x = await api.get<BlogFull>(`/api/content-factory/blogs/${id}/` + (fq ? `?q=${encodeURIComponent(fq)}` : ""));
  ...
  return (
    <div className="cf-blog-ed">
      ...
      <div className="cf-card">
        <h3>{kb ? "Записи бази" : "База знань блогу"} · {(b.facts_total ?? b.facts.length).toLocaleString("uk-UA")}</h3>
        ...
        {(b.facts_total ?? 0) > 100 && (
          <form className="cf-fact-search" onSubmit={(e) => { e.preventDefault(); setFq(fqIn.trim()); }}>
            <input className="cf-in" value={fqIn} onChange={(e) => setFqIn(e.target.value)} placeholder="Пошук у базі: слово або фраза (напр. «оффер», «найм», «прогрів»)" aria-label="Пошук у базі знань" />
            <button type="submit" className="cf-btn ghost"><Icon n="search" size={14} /> Знайти</button>
            <span className="cf-quiet">{b.facts_q ? `Знайдено ${(b.facts_found ?? 0).toLocaleString("uk-UA")}` : "Останні записи"} · показано {b.facts.length}</span>
          </form>)}
...
function Blogs({ blogs, blogId, setBlogId, reload, go }: { blogs: BlogT[]; blogId: number | null; setBlogId: (id: number) => void; reload: () => void; go?: (t: string) => void }) {
  ...
  return (
    <>
      <div>
        <h1 className="cf-h1">Профіль блогу</h1>
        <p className="cf-sub">Виберіть блог — усі вкладки групи «Вибраний блог» зліва працюють з ним. Нижче — його мета, майстер-промт, заклик і записи. Спільні бази знань тепер окремо, у групі «Бази знань».</p>
      </div>
...
type AgentMsg = { who: "me" | "agent"; text: string; at: string; role?: string; model?: string; cost?: number; kb?: string[] };
type AgentChatT = { id: number; title: string; role: string; model: string; blog_id: number | null; cost_usd: number; updated_at: string; n: number; messages?: AgentMsg[] };
type AgentData = { models: { id: string; name: string; provider: string; price: string; hint: string }[]; default_model: string;
  roles: { id: string; name: string }[]; chats: AgentChatT[]; spent_month_usd: number; cap_usd: number };
type DashT = { title?: string; kpis?: { label: string; value: string; note?: string }[]; bars?: { title: string; items: { label: string; value: number }[] }[] };

const ROLE_ICON: Record<string, string> = { marketer: "megaphone", smm: "instagram", analyst: "chart", producer: "video" };
const AGENT_STARTERS: Record<string, string[]> = {
  marketer: ["Розбери позиціонування блогу й запропонуй 3 офери", "Яких тем бракує у воронці: від холодної аудиторії до заявки?"],
  smm: ["Склади контент-план на тиждень: рубрики, формати, дні й час", "Оціни профіль блогу: біо, рубрики, частоту, формати"],
  analyst: ["Зроби дашборд по Telegram за 30 днів і 3 висновки", "Які питання клієнтів ще не закриті контентом?"],
  producer: ["Сценарій рилсу 15 с на найчастіше питання клієнтів", "5 гачків на перші 1,5 секунди для рилсів про Галатею"],
};

function mdInline(t: string, key: string) {
  ...
  while ((m = rx.exec(t))) {
    ...
    const x = m[0];
    out.push(x.startsWith("**") ? <b key={key + i}>{x.slice(2, -2)}</b> : x.startsWith("`") ? <code key={key + i}>{x.slice(1, -1)}</code>
      : <a key={key + i} href={x} target="_blank" rel="noreferrer">{x}</a>);
    last = m.index + x.length; i += 1;
  }
  if (last < t.length) out.push(t.slice(last));
  return out;
}

function Dashboard({ d }: { d: DashT }) {
  return (
    <div className="cf-dash">
      {d.title && <b className="cf-dash-t">{d.title}</b>}
      {!!d.kpis?.length && <div className="cf-dash-kpis">{d.kpis.slice(0, 6).map((k, i) => (
        <div key={i} className="cf-kpi"><span>{k.label}</span><b>{k.value}</b>{k.note && <small>{k.note}</small>}</div>))}</div>}
      {(d.bars || []).slice(0, 3).map((b, i) => {
        const max = Math.max(1, ...b.items.map((x) => Number(x.value) || 0));
        return (
          <div key={i} className="cf-dash-bars"><span>{b.title}</span>
            {b.items.slice(0, 10).map((x, j) => (
              <div key={j} className="row"><em>{x.label}</em><i style={{ width: `${Math.max(2, (Number(x.value) || 0) / max * 100)}%` }} /><b>{Number(x.value).toLocaleString("uk-UA")}</b></div>))}
          </div>);
      })}
    </div>
  );
...
/** Markdown відповіді агента: заголовки, списки, таблиці, жирний, код, блок ```dashboard. Без бібліотек. */
function AgentText({ text }: { text: string }) {
  ...
  while (i < lines.length) {
    ...
    if (l.trim().startsWith("```")) {
      const lang = l.trim().slice(3).trim(); const body: string[] = []; i += 1;
      while (i < lines.length && !lines[i].trim().startsWith("```")) { body.push(lines[i]); i += 1; }
      i += 1;
      if (lang === "dashboard") {
        try { out.push(<Dashboard key={i} d={JSON.parse(body.join("\n"))} />); continue; } catch { /* покажемо як код */ }
      }
      out.push(<pre key={i} className="cf-ag-pre">{body.join("\n")}</pre>); continue;
    }
    if (/^\s*\|.*\|\s*$/.test(l)) {
      const rows: string[][] = [];
      ...
      out.push(<div key={i} className="cf-ag-tw"><table><thead><tr>{rows[0].map((c, j) => <th key={j}>{mdInline(c, `h${i}${j}`)}</th>)}</tr></thead>
        <tbody>{rows.slice(1).map((r, a) => <tr key={a}>{r.map((c, j) => <td key={j}>{mdInline(c, `c${i}${a}${j}`)}</td>)}</tr>)}</tbody></table></div>);
      continue;
    }
    const h = l.match(/^(#{1,4})\s+(.*)$/);
    if (h) { out.push(h[1].length <= 2 ? <h3 key={i}>{mdInline(h[2], `t${i}`)}</h3> : <h4 key={i}>{mdInline(h[2], `t${i}`)}</h4>); i += 1; continue; }
    if (/^\s*([-*]|\d+[.)])\s+/.test(l)) {
      ...
      out.push(<Tag key={i}>{items.map((x, j) => <li key={j}>{mdInline(x, `l${i}${j}`)}</li>)}</Tag>); continue;
    }
    if (l.trim()) out.push(<p key={i}>{mdInline(l, `p${i}`)}</p>);
    i += 1;
  }
  return <div className="cf-ag-md">{out}</div>;
}

function AgentPage({ blogs, blog }: { blogs: BlogT[]; blog: BlogT | undefined }) {
  const [d, setD] = useState<AgentData | null>(null);
  const [chat, setChat] = useState<AgentChatT | null>(null);
  const [role, setRole] = useState("marketer");
  const [model, setModel] = useState("");
  const [blogId, setBlogId] = useState<number | null>(blog?.id ?? null);
  const [text, setText] = useState("");
  const [busy, setBusy] = useState(false);
  const [err, setErr] = useState("");
  const endRef = useRef<HTMLDivElement>(null);
  const load = useCallback(async () => {
    const x = await api.get<AgentData>("/api/content-factory/agent/");
    setD(x); setModel((m) => m || x.default_model);
  }, []);
  useEffect(() => { load().catch(() => setErr("Не вдалося завантажити агента.")); }, [load]);
  useEffect(() => { endRef.current?.scrollIntoView({ block: "end" }); }, [chat?.messages?.length, busy]);
  const open = async (id: number) => {
    setErr("");
    try { const c = await api.get<AgentChatT>(`/api/content-factory/agent/${id}/`); setChat(c); setRole(c.role); setModel(c.model); setBlogId(c.blog_id); }
    catch { setErr("Не вдалося відкрити чат."); }
  };
  const send = async (t?: string) => {
    const msg = (t ?? text).trim();
    if (!msg || busy) return;
    setBusy(true); setErr("");
    const optimistic: AgentMsg = { who: "me", text: msg, at: new Date().toISOString(), role, model };
    setChat((c) => ({ ...(c || { id: 0, title: msg.slice(0, 80), role, model, blog_id: blogId, cost_usd: 0, updated_at: "", n: 0 }), messages: [...(c?.messages || []), optimistic] }));
    setText("");
    try {
      const c = await api.post<AgentChatT & { spent_month_usd: number }>("/api/content-factory/agent/", { chat_id: chat?.id || null, text: msg, role, model, blog_id: blogId });
      setChat(c); setD((x) => x && { ...x, spent_month_usd: c.spent_month_usd, chats: [c, ...x.chats.filter((y) => y.id !== c.id)] });
    } catch (e: any) {
      setErr(e?.data?.error || "Агент не відповів. Спробуйте ще раз або іншу модель.");
      setChat((c) => c && { ...c, messages: (c.messages || []).filter((m) => m !== optimistic) }); setText(msg);
    } finally { setBusy(false); }
  };
  const del = async (id: number) => {
    try { await api.del(`/api/content-factory/agent/${id}/`); if (chat?.id === id) setChat(null); load(); } catch { setErr("Не вдалося видалити."); }
  };
  if (!d) return <div className="cf-empty">{err || "Завантажую…"}</div>;
  const mInfo = d.models.find((m) => m.id === model);
  const roleName = (id?: string) => d.roles.find((r) => r.id === id)?.name || "";
  const modelName = (id?: string) => d.models.find((m) => m.id === id)?.name || id || "";
  const copy = (t: string) => { try { navigator.clipboard.writeText(t); } catch { /* буфер недоступний */ } };
  return (
    <>
      <div>
        <h1 className="cf-h1">Агент заводу</h1>
        <p className="cf-sub">Дайте завдання як маркетологу, SMM-спеціалісту, аналітику чи продюсеру. Агент бачить дані заводу вибраного блогу
          (рилси, каруселі, Telegram, питання клієнтів, звіт аналітика, стрічку) і бази знань «Маркетинг» та «Бізнес і найм». Відповідає документом,
          таблицею або дашбордом. Сам нічого не публікує й не змінює.</p>
      </div>
      <div className="cf-ag">
        <aside className="cf-ag-list">
          <button type="button" className="cf-btn gold" onClick={() => { setChat(null); setErr(""); }}><Icon n="plus" size={14} /> Новий чат</button>
          <small className="cf-quiet">Витрачено {money(d.spent_month_usd)} з ${d.cap_usd} цього місяця</small>
          {d.chats.map((c) => (
            <div key={c.id} className={"cf-ag-item" + (chat?.id === c.id ? " on" : "")}>
              <button type="button" onClick={() => open(c.id)} title={c.title}>
                <Icon n={ROLE_ICON[c.role] || "bot"} size={14} /><span>{c.title}</span></button>
              <button type="button" className="x" aria-label="Видалити чат" onClick={() => del(c.id)}><Icon n="trash" size={13} /></button>
            </div>))}
          {!d.chats.length && <small className="cf-quiet">Чатів ще немає.</small>}
        </aside>
        <section className="cf-ag-main">
          <div className="cf-ag-bar">
            <div className="cf-ag-roles" role="group" aria-label="Роль агента">
              {d.roles.map((r) => (
                <button key={r.id} type="button" aria-pressed={role === r.id} className={role === r.id ? "on" : ""} onClick={() => setRole(r.id)}>
                  <Icon n={ROLE_ICON[r.id] || "bot"} size={14} />{r.name}</button>))}
            </div>
            <div className="cf-ag-sel">
              <Pick label="Модель ШІ" value={model} onChange={setModel} opts={d.models.map((m) => ({ v: m.id, l: m.name, hint: m.price }))} />
              <Pick label="Дані якого блогу" value={String(blogId ?? "")} onChange={(v) => setBlogId(v ? Number(v) : null)}
                opts={[{ v: "", l: "Увесь завод" }, ...blogs.map((b) => ({ v: String(b.id), l: b.name }))]} />
            </div>
            {mInfo && <small className="cf-quiet">{mInfo.name}: {mInfo.hint} · {mInfo.price}. GPT-5 від OpenAI потребує окремого ключа — зараз його немає.</small>}
          </div>
          <div className="cf-ag-log" aria-live="polite">
            {!chat?.messages?.length && (
              <div className="cf-ag-empty">
                <b>З чого почати ({roleName(role)}):</b>
                {(AGENT_STARTERS[role] || []).map((t) => <button key={t} type="button" className="cf-btn ghost" onClick={() => send(t)}>{t}</button>)}
              </div>)}
            {(chat?.messages || []).map((m, i) => (
              <div key={i} className={"cf-ag-msg " + m.who}>
                {m.who === "agent" ? <AgentText text={m.text} /> : <p>{m.text}</p>}
                <div className="meta">
                  {m.who === "agent" ? <>{roleName(m.role)} · {modelName(m.model)}{m.cost != null ? ` · ${money(m.cost)}` : ""}
                    <button type="button" className="cf-btn ghost" onClick={() => copy(m.text)}><Icon n="copy" size={12} /> Копіювати</button></> : null}
                  {!!m.kb?.length && <details><summary>Записи бази в контексті · {m.kb.length}</summary><ul>{m.kb.map((k) => <li key={k}>{k}</li>)}</ul></details>}
                </div>
              </div>))}
            {busy && <div className="cf-ag-msg agent busy">Агент думає… (Pro-моделі — до хвилини)</div>}
            <div ref={endRef} />
          </div>
          {err && <div className="cf-msg err" role="alert">{err}</div>}
          <form className="cf-ag-in" onSubmit={(e) => { e.preventDefault(); send(); }}>
            <textarea className="cf-ta" value={text} onChange={(e) => setText(e.target.value)} placeholder={`Завдання для «${roleName(role)}»… (Enter — надіслати, Shift+Enter — новий рядок)`}
              aria-label="Завдання агенту" onKeyDown={(e) => { if (e.key === "Enter" && !e.shiftKey) { e.preventDefault(); send(); } }} />
            <button type="submit" className="cf-btn gold" disabled={busy || !text.trim()}><Icon n="send" size={14} /> Надіслати</button>
          </form>
        </section>
      </div>
    </>
...
export default function ContentFactory() {
  ...
  const realBlogs = blogs.filter((b) => !KB_SLUGS.includes(b.slug)); // бази знань — не блоги
  const blog = realBlogs.find((b) => b.id === blogId) || realBlogs.find((b) => b.is_default) || realBlogs[0];
  const ctx: BlogCtx = { blogs: realBlogs, blogId: blog?.id ?? null, setBlogId };
  const load = useCallback(async () => {
    try {
  ...
  return (
    <div className="cf">
      ...
      <main className="cf-main">
        ...
        {err && <div className="cf-msg err" role="alert">{err}</div>}
        <Masthead s={section} blog={blog} />
        {section.id === "studio" ? <Studio ov={ov} go={go} />
          : section.id === "agent" ? <AgentPage blogs={realBlogs} blog={blog} />
          : section.id === "channels" ? <Channels data={list} reload={load} blogs={realBlogs} blog={blog} />
          : section.id === "questions" ? <Questions />
          : section.scope === "kb" ? <KbPage key={section.id} s={section} all={blogs} reload={loadBlogs} />
          ...
          : section.id === "sources" ? <Sources key={blog?.id} blog={blog} blogs={realBlogs} />
