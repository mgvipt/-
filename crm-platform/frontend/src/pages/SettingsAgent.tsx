...
export default function SettingsAgent() {
  ...
  return (
    <div>
      ...
      <ModelSel k="priority_model" label={t("ИИ-РОП: приоритет чатов", "ИИ-РОП: приоритет чатів")} desc={t(
        ...
        "Бейдж приоритету (терміново / обурення / прорахунок). АВТО кожні 5 хв на кожне нове повідомлення — найчастіша витрата. Класифікації вистачає Haiku → економія ×4. Реком.: Haiku.")} />
      <Toggle k="priority_enabled" label={t("Авто-приоритет чатов включён", "Авто-приоритет чатів увімкнено")} desc={t("Выкл = бейджи приоритета вообще не считаются (0 расход на это). Чаты не пострадают.", "Вимк = бейджі приоритету взагалі не рахуються (0 витрат на це). Чати не постраждають.")} />
