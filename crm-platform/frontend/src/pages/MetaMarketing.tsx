        ...
        {tab === "creatives" && <>
          ...
          <div className="note" style={{ marginBottom: 12 }}>
            ...
            <div style={{ marginTop: 6, lineHeight: 1.55 }}>
              ...
              • {t("расход идёт, а диалогов нет — креатив не работает, менять", "витрати йдуть, а діалогів немає — креатив не працює, міняти")}
            </div>
          </div>
  ...
  return <div className="panel" style={{ padding: 13 }}>
    ...
    <div style={metricGrid}>
      ...
      <Metric label={t("Лиды Meta", "Ліди Meta")} value={count(row.meta_leads)}
        tip={t("Оценка САМОЙ Meta: сколько действий она засчитала себе как заявку (заполненная лид-форма, нажатие «Написать»). Считает у себя, по своим правилам, и людей не показывает — только число. Может не совпадать с нашей CRM в обе стороны. Это справка, а не факт.", "Оцінка САМОЇ Meta: скільки дій вона зарахувала собі як заявку. Рахує у себе, за своїми правилами, людей не показує — лише число. Це довідка, а не факт.")} />
