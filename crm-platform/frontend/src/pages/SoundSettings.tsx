...
export default function SoundSettings() {
  ...
  return (
    <div className="panel" style={{ margin: "0 0 12px", maxWidth: 400 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 6 }}>
        <span style={{ fontSize: 13, fontWeight: 600 }}>📦 {t("Новые задачи на отгрузке (полоса + звук)", "Нові задачі на відвантаженні (смуга + звук)")}</span>
        <span className={"toggle" + (whOn ? " on" : "")} onClick={() => { const v = !whOn; setWhOnS(v); setWhNotifyOn(v); }} />
      </div>
      <div className="muted" style={{ fontSize: 11.5, marginBottom: 16 }}>{t("Только для сотрудников склада. Выключил — не будет ни полосы, ни звука о новых задачах в общей очереди.", "Тільки для співробітників складу. Вимкнув — не буде ні смуги, ні звуку про нові задачі у спільній черзі.")}</div>
      ...
      <div className="muted" style={{ fontSize: 11.5, marginTop: 10 }}>
        {t("Загруженные звуки общие — их видят и могут выбрать все сотрудники. Одинаковые файлы не дублируются. Выбор звука хранится на этом устройстве.",
          "Завантажені звуки спільні — їх бачать і можуть обрати всі співробітники. Однакові файли не дублюються. Вибір звуку зберігається на цьому пристрої.")}
      </div>
    </div>
  );
}
