...
export default function Settings() {
  ...
  async function addReply() { await api.post("/api/inbox/media-library/", replyEditId ? { action: "update_reply", id: replyEditId, title: replyTitle, text: replyText, asset_ids: replyAssets, category: replyCat, when_to_use: replyWhen } : { action: "reply", title: replyTitle, text: replyText, asset_ids: replyAssets, category: replyCat, when_to_use: replyWhen }); setReplyTitle(""); setReplyText(""); setReplyAssets([]); setReplyEditId(null); setReplyCat(""); setReplyWhen(""); loadLibrary(); }
